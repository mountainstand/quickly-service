...
extension Log on Object? {
  void log() => devtools.log("Quickly VPN Logs: ${toString()}");
  void logWith({
...
extension ExtractDouble on String {
  double getDoubleValue() {
    String numericString = replaceAll(RegExp(r'[^0-9.]'), '');
...
extension DecimalPointPrecision on double {
  double formatDouble({required int to}) {
    return num.parse(toStringAsFixed(to)).toDouble();
  }
}

extension IntToSeconds on int {
