...
//Refernce from link:- https://github.com/Caqil/wireguard_flutter/tree/main/example
...
class PacketTunnelProvider: NEPacketTunnelProvider {
    ...
    /// For setting up kill switch
    private func configureOnDemandVPN() {
        ...
        vpnManager.loadFromPreferences { error in
            ...
            rule.interfaceTypeMatch = .any // Change to .cellular if needed
            ...
            vpnManager.saveToPreferences { error in
                if let error = error {
                    ...
                    print("On-Demand VPN is successfully configured.")
                }
            }
        }
    }
